...
import com.rocoman.game.sprite.Bird;
import com.rocoman.game.sprite.Tube;
...
public class PlayState extends State{
    ...
    public void update(float dt) {
        ...
        for (int i =0 ; i<tubes.size;i++){
            ...
            if(cam.position.x -(cam.viewportHeight/2)>tube.getPosTopTube().x+tube.getTopTube().getWidth()){
